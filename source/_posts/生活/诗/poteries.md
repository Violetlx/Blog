        ...
        if site.data.collect
            ...
            each i in site.data.collect
                ...
                each j in i.link_list
                    -
                        listResult += `<div title="${j.name}" referrerPolicy="no-referrer" class="icat-collect_box" style="${j.img ? `background-image: url(${j.img})` : 'background-color: var(--icat-card-bg);'}">
